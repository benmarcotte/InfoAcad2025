// 1. e) Given several dice of varying sizes, determine the probability of rolling a given value n.
...
// 1. e) Déterminez la probabilité d'obtenir une valeur n à partir de plusieurs dés de tailles différentes.
